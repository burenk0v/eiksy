...
- [ ] The tagged release workflow produces Linux amd64 and Windows amd64 desktop artifacts.
- [ ] The tagged release workflow produces Linux amd64 and Windows amd64 CLI artifacts.
